...
`--rpm-system` must be explicit. Supported values are `el9`, `fc40`, `fc41`,
`fc43`, `fc44`, `openeuler2203`, and `openeuler2403`. The generic `openeuler` value is
...
--rpm-system fc41 --rpm-release 3 --rpm-arch x86_64
