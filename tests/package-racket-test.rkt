  ...
  (test-case "deb-spec writes generated scaffold into a temporary deb repository"
    (with-temp-dir
     (lambda (tmp)
       ...
       (check-contains (file->string common-script) "staged Rhombus demod cache")
       ...
       (check-contains (file->string common-script) "-U -R \"$runtime_cache_root\"")
       ...
       (check-contains (file->string build-script) "racket -U -R \"$compiled_cache_root\"")
